...
pub async fn get_advisory_by_id(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<GetAdvisoryByIdError>> {
...
pub async fn get_by_enisa_id(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<GetByEnisaIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
...
pub async fn get_vulnerability_by_id(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<GetVulnerabilityByIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
